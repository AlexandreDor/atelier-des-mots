...
| `fr-lieux-rivieres`, `fr-lieux-montagnes`, `fr-lieux-forets`, `fr-lieux-plages` | [GeoNames `FR.txt`](https://download.geonames.org/export/dump/FR.zip), export quotidien récupéré le 9 août 2026 | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | Filtrage des types géographiques, retrait des désignations génériques (« forêt », « bois », « mont », « plage », etc.), normalisation et échantillonnage déterministe. Attribution : GeoNames, données modifiées. |
...
| `en-lieux-villes`, `hu-lieux-villes`, `es-lieux-villes` | [GeoNames `GB.txt`, `HU.txt` et `ES.txt`](https://download.geonames.org/export/dump/), exports quotidiens récupérés le 9 août 2026 | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) | Filtrage des lieux peuplés, sélection des 2 500 villes anglaises, 1 000 villes hongroises et 2 500 villes espagnoles, normalisation et dédoublonnage. Attribution : GeoNames, données modifiées. |
| `hu-rues-routes`, `es-rues-routes` | Extraits [OpenStreetMap de Hongrie](https://download.geofabrik.de/europe/hungary.html), d’Espagne et des [Canaries](https://download.geofabrik.de/africa/canary-islands.html), récupérés le 9 août 2026 | [ODbL 1.0](https://opendatacommons.org/licenses/odbl/1-0/) | Extraction des voies nommées, retrait des désignations génériques de rue et de route dans les langues concernées, conservation des noms locaux espagnols, normalisation, dédoublonnage et échantillonnage déterministe de 5 000 noms par pays. Attribution : © OpenStreetMap contributors, extraits Geofabrik. |
